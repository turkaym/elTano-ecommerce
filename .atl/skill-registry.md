# Skill Registry — elTano_ecommerce
...
- C:\Users\marco\.cursor\skills
- C:\Users\marco\.copilot\skills
- C:\Users\marco\.codex\skills
...
### branch-pr
- Path: C:\Users\marco\.config\opencode\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\marco\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\marco\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\marco\.config\opencode\skills\comment-writer\SKILL.md
...
### go-testing
- Path: C:\Users\marco\.config\opencode\skills\go-testing\SKILL.md
...
### imagegen
- Path: C:\Users\marco\.codex\skills\.system\imagegen\SKILL.md
- Rules:
...
### issue-creation
- Path: C:\Users\marco\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\marco\.config\opencode\skills\judgment-day\SKILL.md
...
### openai-docs
- Path: C:\Users\marco\.codex\skills\.system\openai-docs\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### plugin-creator
- Path: C:\Users\marco\.codex\skills\.system\plugin-creator\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: C:\Users\marco\.config\opencode\skills\skill-creator\SKILL.md
...
### skill-installer
- Path: C:\Users\marco\.codex\skills\.system\skill-installer\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### slides
- Path: C:\Users\marco\.codex\skills\codex-primary-runtime\slides\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### spreadsheets
- Path: C:\Users\marco\.codex\skills\codex-primary-runtime\spreadsheets\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: C:\Users\marco\.config\opencode\skills\work-unit-commits\SKILL.md
